...
static void glad_gl_load_GL_NV_path_rendering( GLADuserptrloadfunc load, void* userptr) {
    ...
    glGetPathColorGenfvNV = (PFNGLGETPATHCOLORGENFVNVPROC) load("glGetPathColorGenfvNV", userptr);
    glGetPathColorGenivNV = (PFNGLGETPATHCOLORGENIVNVPROC) load("glGetPathColorGenivNV", userptr);
    ...
    glGetPathTexGenfvNV = (PFNGLGETPATHTEXGENFVNVPROC) load("glGetPathTexGenfvNV", userptr);
    glGetPathTexGenivNV = (PFNGLGETPATHTEXGENIVNVPROC) load("glGetPathTexGenivNV", userptr);
    ...
    glMatrixTranslatedEXT = (PFNGLMATRIXTRANSLATEDEXTPROC) load("glMatrixTranslatedEXT", userptr);
    glMatrixTranslatefEXT = (PFNGLMATRIXTRANSLATEFEXTPROC) load("glMatrixTranslatefEXT", userptr);
    glPathColorGenNV = (PFNGLPATHCOLORGENNVPROC) load("glPathColorGenNV", userptr);
    ...
    glPathFogGenNV = (PFNGLPATHFOGGENNVPROC) load("glPathFogGenNV", userptr);
    ...
    glPathTexGenNV = (PFNGLPATHTEXGENNVPROC) load("glPathTexGenNV", userptr);
